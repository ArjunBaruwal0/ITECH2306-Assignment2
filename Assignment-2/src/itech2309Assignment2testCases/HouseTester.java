...
public class HouseTester {
	...
	public void getHouseScheduleForADay() {
		...
		assertEquals(true, time1.addHouseInspection(home1));
		assertEquals("12 hms buffalo ave, edwardstownat:      10:00am - 10:15am: Thursday", time1.getInspectionSchedule("Thursday"));
